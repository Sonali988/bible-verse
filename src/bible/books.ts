...
/** Common English abbreviations (USFM-style), keyed by the same numeric `id`. */
const BOOK_ABBREV_BY_ID: Record<string, string> = {
  "1": "Gen",
  "2": "Exod",
  "3": "Lev",
  "4": "Num",
...
export function bookAbbrevById(bookId: string): string {
  return BOOK_ABBREV_BY_ID[bookId] ?? bookNameById(bookId);
}
